...
export default defineComponent({
    props: {
        servicesSectionElement: {type: HTMLElement, required: true}
    },
    setup(props) {
        const viewPortHeight = `${window.innerHeight - 130}px`
        const scrollDown = () => {
            props.servicesSectionElement.scrollIntoView({behavior: "smooth"});
